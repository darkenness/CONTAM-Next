...
export default function Toolbar() {
  ...
  return (
    <header className="h-11 bg-white/90 backdrop-blur-sm border-b border-slate-200/80 flex items-center px-3 gap-1 shrink-0 select-none shadow-sm">
      {/* Logo */}
      <div className="flex items-center gap-1.5 mr-3">
        <div className="w-5 h-5 rounded bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center text-[8px] font-black text-white leading-none">C</div>
        <span className="font-semibold text-slate-800 text-[13px] tracking-tight">CONTAM-Next</span>
      </div>
